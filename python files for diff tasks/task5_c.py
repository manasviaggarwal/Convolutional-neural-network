    ...
    def initialization_layers_train(self,train_path,test_path,dataset,no_of_layers,filter_sizes):
           ...
           # y_true_cls=tf.Variable(y_true_cls)
            if dataset=="Fashion-MNIST":
                ...
                layer_conv1, weights_conv1 = self.new_conv_layer(input=x_image, num_input_channels=3, filter_size=filter_sizes[0], num_filters=64, name ="conv1")
...
print("--------Training----------")
cn=CNN1()
cn.initialization_layers_train("f","f","CIFAR-10",2,[8,8])
